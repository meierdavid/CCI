...
<!--Pulling Awesome Font -->
    ...
    <div class="row">
        <div class="col-md-offset-3 col-md-5">
            ...
            <?php ?> // formulaire d'inscription commercant
            ...
            <form>
                <br></br>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nomCommercant" value="" size="30" required/>
                    </div>    
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="adresseCommercant" value="" size="30" required/>
                    </div>    
                    <div class="form-group">
                        <label class="control-label">Code postale</label>
                        <input type="text" class="form-control" name="codePCommercant" value="" size="30" required/>
                    </div> 
                    <div class="form-group">
                        <label class="control-label">Ville</label>
                        <input type="text" class="form-control" name="villeCommercant" value="" size="30" required/>
                    </div>    
                    <div class="form-group">
