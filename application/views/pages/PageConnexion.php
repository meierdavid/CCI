...
<!--Pulling Awesome Font -->
    ...
    <div class="row">
        <div class="col-md-offset-3 col-md-5">
            ...
            <div class="text-center">
            <a class="btn btn-primary" href="<?php echo base_url()?>controllers/PageCtrl/ConnexionSellers" role="button">Commercant ? Cliquez ici !</a>
            </div>

            <br></br>

            <div class="text-center">
            <a class="btn btn-primary" href="<?php echo base_url()?>controllers/PageCtrl/ConnexionAdmin" role="button">Administrateur ? Cliquez ici !</a>
            </div>
